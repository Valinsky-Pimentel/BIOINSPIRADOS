...
var = 5;
NP = 11;  % Tamaño de la población
F = 0.68;  % Factor de amplificación-muta
CR = 0.68; % Tasa de recombinación
% O = 1e-5;
generaciones = 610; % Número de generaciones
